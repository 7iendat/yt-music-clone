                ...
                <div className="">
                    <ul className="category-ul categories-scoll scrollbox">
                        {categories.map((main, i) => (
                            <li style={{borderLeftColor:main.color}} className={` w-full   inline-block mt-[5px] border-l-[6px] border-l-${main.color} leading-7 scroll-ml-96 bg-[#292929] rounded hover:bg-[#212121]  `}>
                                <Link to={`${main.link}`} className="color-category flex justify-start normal-case text-center ">
                                    
                                    <span className=" leading-[44px] w-full   border-none text-white text-[14px] font-medium px-[12px] text-center ">
                                        {main.name}
                                        </span>
                                </Link>
                            </li>
